...
chatlog-exporter is distributed as agent skills. Install them with `gh skill` or `npx skills`, run
`/setup-chatlogs` once in your project, then run a slash command from that directory.
