// src: skills/_cle-libs/libs/path-utils/__tests__/unit/path-utils.unit.spec.ts
// @(#): path-utils ユニットテスト
//
...
describe('normalizePath', () => {
  ...
  /** T-LIB-U-82: normalizePath に env プロバイダーを渡すと、その関数で環境変数が展開される。 */
  describe('When: env プロバイダーを渡す', () => {
    beforeEach(() => resetProjectRoot('/mock/root'));
    afterEach(() => resetProjectRoot());
